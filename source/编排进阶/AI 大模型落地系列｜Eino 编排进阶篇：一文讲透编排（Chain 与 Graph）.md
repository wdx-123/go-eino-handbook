声明：本文数据源于官方文档与官方示例，重点参考 [Chain/Graph 编排介绍](https://www.cloudwego.io/zh/docs/eino/core_modules/chain_and_graph_orchestration/chain_graph_introduction/)、[编排的设计理念](https://www.cloudwego.io/zh/docs/eino/core_modules/chain_and_graph_orchestration/orchestration_design_principles/) 与 [eino-examples/compose](https://github.com/cloudwego/eino-examples/tree/main/compose)。
@[TOC](一文讲透 Chain 与 Graph 的设计价值、运行方式与工程落地)
