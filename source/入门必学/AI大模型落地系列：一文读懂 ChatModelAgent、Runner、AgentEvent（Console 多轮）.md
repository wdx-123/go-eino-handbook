...
声明：本文数据源于官方文档与官方实现[[第二章官方文档]](https://www.cloudwego.io/zh/docs/eino/quick_start/chapter_02_chatmodelagent_runner_agentevent/)[[示例代码]](https://github.com/cloudwego/eino-examples/blob/main/quickstart/chatwitheino/cmd/ch02/main.go)。
@[TOC](AI大模型落地系列：一文读懂 ChatModelAgent、Runner、AgentEvent（Console 多轮）)
