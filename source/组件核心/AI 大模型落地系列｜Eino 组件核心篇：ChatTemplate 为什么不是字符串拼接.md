...
声明：本文数据源于官方文档与官方实现，重点参考 [ChatTemplate 使用说明](https://www.cloudwego.io/zh/docs/eino/core_modules/components/chat_template_guide/)。
@[TOC](为什么很多人学 Eino 后，写 Prompt 时还是把 ChatTemplate 用成了字符串拼接？)
