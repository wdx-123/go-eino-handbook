...
声明：本文数据源于官方文档与官方实现，重点参考 [Indexer 使用说明](https://www.cloudwego.io/zh/docs/eino/core_modules/components/indexer_guide/)， 以及 `eino/components/indexer/interface.go`、`eino/components/indexer/option.go` 相关源码。
@[TOC](为什么很多人会用 Indexer，却没真正看懂 Store)
